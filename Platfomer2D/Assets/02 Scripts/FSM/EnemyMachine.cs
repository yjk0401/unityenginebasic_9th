...
public class EnemyMachine : CharacterMachine
{
    ...
    private void Start()
    {
        Initialize(CharacterStateWorkflowsDataSheet.GetWorkflowsForEmemy(this));
            ...
            case AI.ExcuteRandomBehaviour:
                {
                    ...
                    if (ChangeState(behaviour)) 
                    {
                        ...
                        _ai = AI.WaitUtilRandomBehaviourFinihed;
                    }
                }
                break;
            case AI.WaitUtilRandomBehaviourFinihed:
                {
                    if (_thinkTimer <= 0)
                    {
                        _ai = AI.Think;
