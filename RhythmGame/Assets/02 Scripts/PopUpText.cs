...
public class PopUpText : MonoBehaviour
{
    ...
    [SerializeField] private Vector3 _derection = Vector3.up;
    ...
    public void PopUp(string newMassage)
    {
        _message.text = newMassage;
        PopUp();
    }
    ...
    private void Update()
    {
        transform.Translate(_derection * _moveSpeed * Time.deltaTime);
