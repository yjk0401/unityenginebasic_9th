...
public class PopUpTextManager : MonoBehaviour
{
    ...
    public void PopUpHitJudgeText(HitJudge hitJudge) 
    {
        ...
        if (_great.gameObject.activeSelf) _cool.transform.position += Vector3.forward;
        if (_good.gameObject.activeSelf) _cool.transform.position += Vector3.forward;
        if (_miss.gameObject.activeSelf) _cool.transform.position += Vector3.forward;
        if (_bad.gameObject.activeSelf) _cool.transform.position += Vector3.forward;
